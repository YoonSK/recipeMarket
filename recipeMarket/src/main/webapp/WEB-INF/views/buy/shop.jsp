...
<body>
	...
	<div class="s_category">
	    ...
	    <ul>
		    <li><a href="/shop/index.html?cateCd=008">신선식품</a></li>
		    <li><a href="/shop/index.html?cateCd=006">간편식</a></li>
		    <li><a href="/shop/index.html?cateCd=004">가공식품</a></li>
	    </ul>
    </div>
	</header>
	<div class="s_contents">
		<div class="s_list_ea" style="margin-top:5px;height:15px;">신선식품 상품</div>
		<div class="s_list">
